                ...
                @foreach(session('cart') as $id => $details)
                    ...
                    <tr data-id="{{ $id }}">
                        <td data-th="Hidangan" class="justify-content-center">
                            <div class="row">
                                <div class="col-sm-3 hidden-xs"><img src="{{ asset('storage/gambar_hidangan/'.$details['gambar']) }}" width="100" height="100" class="img-responsive"/></div>
                                <div class="col-sm-9">
